<template>
    ...
    <section class="container mb-5 pb-lg-5">
        <div
            class="row align-items-center justify-content-lg-start justify-content-center flex-lg-nowrap gy-4"
        >
            <div class="col-lg-9">
                <img
                    class="rounded-3"
            ...
            <div class="col-lg-4 ms-lg-n5 col-sm-9 text-lg-start text-center">
                <div class="ms-lg-n5 pe-xl-5">
                    ...
                    <p class="mb-4 pb-lg-3 fs-lg text-light opacity-70">
                        We believe that car buying and selling should be
                        straight-forward and enjoyable, not time-consuming,
                        complicated or stressful.
                    </p>
                    <a
                        class="btn btn-lg btn-primary w-sm-auto w-100"
                        href="car-finder-catalog-list.html"
                        ><i class="fi-search me-2"></i>Search car</a
                    >
                </div>
            </div>
        </div>
