                    ...
                    <div class="col-lg-3 pe-xl-4">
                        ...
                        >
                            ...
                            <div class="offcanvas-body py-lg-4">
                                <div
                                    class="pb-3 mb-4 border-bottom border-light"
                                >
                                    <div
                                        class="d-flex align-items-center justify-content-between mb-3"
                                    >
                                        <h3 class="h6 text-light mb-0">
                                            Selection
                                        </h3>
                                        <button
                                ...
                                <div class="pb-4 mb-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <select
                                            class="form-select form-select-light w-100"
                                        >
                                            <option value="" disabled selected>
                                                From
                                            </option>
                                ...
                                <div class="pb-4 mb-2">
                                    ...
                                    <div
                                        class="form-check form-switch form-switch-light"
                                    >
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                    ...
                    <div class="col-lg-9">
                        ...
                        >
                            ...
                            <div class="text-light">
                                ...
                                ><span class="align-middle">249 offers</span>
                            </div>
                        </div>
                        <!-- Sorting + View-->
                        <div
                        ...
                        >
                            <div class="d-flex align-items-center me-sm-4">
                                <label
                                    class="fs-sm text-light me-2 pe-1 text-nowrap"
                                    for="sorting1"
                                ...
                                <div
                                    class="d-none d-md-block border-end border-light"
                                    style="height: 1.25rem"
                                ></div>
                                <div
                                    class="d-none d-sm-block fw-bold text-light opacity-70 text-nowrap ps-md-4"
                                >
                            ...
                            <div class="d-none d-sm-flex">
                                <a
                                    class="nav-link nav-link-light px-2 active"
                                    href="car-finder-catalog-list.html"
                                    data-bs-toggle="tooltip"
                                    title="List view"
                                    ><i class="fi-list"></i></a
                                ><a
                                    class="nav-link nav-link-light px-2"
                        ...
                        <!-- Item-->
                        <div
                            class="card card-light card-hover card-horizontal mb-4"
                        >
                            <div
                                class="tns-carousel-wrapper card-img-top card-img-hover"
                            >
                                <a
                                    class="img-overlay"
                                ...
                                <div
                                    class="tns-carousel-inner position-absolute top-0 h-100"
                                >
                                    <div
                            ...
                            <div class="card-body">
                                ...
                                <div class="fs-sm text-light opacity-70">
                                    <i class="fi-map-pin me-1"></i>Chicago
                                </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                                        style="
                                            background-image: url(/img/car-finder/catalog/10.jpg);
                                        "
                                    ></div>
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                            ...
                            <div class="card-body">
                                ...
                                <div class="fs-sm text-light opacity-70">
                                    <i class="fi-map-pin me-1"></i>San Francisco
                                </div>
                                <div class="border-top border-light mt-3 pt-3">
                                    <div class="row g-2">
                                        <div class="col me-sm-1">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                                        style="
                                            background-image: url(/img/car-finder/catalog/11.jpg);
                                        "
                                    ></div>
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                            ...
                            <div class="card-body">
                                ...
                                <div class="fs-sm text-light opacity-70">
                                    <i class="fi-map-pin me-1"></i>Los Angeles
                                </div>
                                <div class="border-top border-light mt-3 pt-3">
                                    <div class="row g-2">
                                        <div class="col me-sm-1">
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                                        style="
                                            background-image: url(/img/car-finder/catalog/12.jpg);
                                        "
                                    ></div>
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                        ...
                        >
                            ...
                            <div class="card-body">
                                ...
                                <div class="fs-sm text-light opacity-70">
                                    <i class="fi-map-pin me-1"></i>New Jersey
                                </div>
                                <div class="border-top border-light mt-3 pt-3">
                                    <div class="row g-2">
                                        <div class="col me-sm-1">
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                                        style="
                                            background-image: url(/img/car-finder/catalog/14.jpg);
                                        "
                                    ></div>
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                                        style="
                                            background-image: url(/img/car-finder/catalog/15.jpg);
                                        "
                                    ></div>
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                                        style="
                                            background-image: url(/img/car-finder/catalog/16.jpg);
                                        "
                                    ></div>
                                    <div
                                        class="bg-size-cover bg-position-center w-100 h-100"
                        ...
                        >
                            <div class="d-flex align-items-center me-sm-4">
                                ...
                                >
                                <select
                                    class="form-select form-select-light form-select-sm me-2 me-sm-4"
                                    id="sorting2"
                                >
                                    <option>Newest</option>
                                    <option>Popular</option>
                                ...
                                ></div>
                                <div
                                    class="d-none d-md-block fw-bold text-light opacity-70 text-nowrap ps-md-4"
                                >
                                    <i class="fi-switch-horizontal me-2"></i
                                    ><span class="align-middle"
                                        >Compare (0)</span
