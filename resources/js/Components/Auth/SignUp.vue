                                ...
                                <div class="row mx-0 align-items-center">
                                    ...
                                    >
                                        <a
                                            ...
                                            href="#"
                                            ><i class="fi-google fs-lg me-1"></i
                                            >Sign in with Google</a
                                        ><a
                                            class="btn btn-outline-info w-100 mb-3"
                                            href="#"
                                            ><i
                                                class="fi-facebook fs-lg me-1"
                                            ></i
                                            >Sign in with Facebook</a
                                        >
                                        <div
                                            class="d-flex align-items-center py-3 mb-3"
                                        >
                                            <hr class="hr-light w-100" />
                                            <div
                                                class="text-light opacity-70 px-3"
                                            >
                                                Or
                                            </div>
                                            <hr class="hr-light w-100" />
                                        ...
                                        >
                                            ...
                                            <div
                                                class="form-check form-check-light mb-4"
                                            >
                                                <input
